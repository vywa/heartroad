...
public class ChatProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.hykj.provider.Chats";
	...
	private static class ChatDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE " + TABLE_NAME + " (" + ChatConstants._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + ChatConstants.SENDER + " TEXT," + ChatConstants.DATE + " INTEGER,"
					+ ChatConstants.DIRECTION + " INTEGER," + ChatConstants.JID + " TEXT," + ChatConstants.MESSAGE + " TEXT," + ChatConstants.DELIVERY_STATUS + " INTEGER,"
