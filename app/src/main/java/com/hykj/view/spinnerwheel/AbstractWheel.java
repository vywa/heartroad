...
package com.hykj.view.spinnerwheel;
...
import com.hykj.view.spinnerwheel.adapters.WheelViewAdapter;
...
//        Log.wtf("getItemDimension", ""+getItemDimension());
//        Log.wtf("mScrollingOffset", ""+mScrollingOffset);
    ...
    public void myScroll(int itemsToScroll, int time){
    	itemsToScroll = itemsToScroll - mCurrentItemIdx;
    	onScrollTouched();
    	mScroller.scroll(itemsToScroll*DensityUtils.dp2px(App.getContext(), 20)- mScrollingOffset, time);
    }
