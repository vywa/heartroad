 ...
 */
public class SetDietTimeView extends Dialog {

    Context context;
    DietConditionActivity activity;
    ...
    public SetDietTimeView(Context context, DietConditionActivity activity) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_dietcondition);
    ...
    private void initViews() {
        mWv_hour = (WheelVerticalView) findViewById(R.id.dialog_dietcondition_wvv_hour);
        mWv_min = (WheelVerticalView) findViewById(R.id.dialog_dietcondition_wvv_min);
        whv_day = (WheelHorizontalView) findViewById(R.id.dialog_dietcondition_wv_day);
        tv_month = (TextView) findViewById(R.id.dialog_dietcondition_tv_month);
        tv_between = (TextView) findViewById(R.id.dialog_dietcondition_tv_between);
