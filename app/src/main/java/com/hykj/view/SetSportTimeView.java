...
import com.hykj.activity.messure.SportConditionActivity;
 ...
 */
public class SetSportTimeView extends Dialog {

    Context context;
    SportConditionActivity activity;
    ...
    public SetSportTimeView(Context context, SportConditionActivity activity) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_sportcondition);
    ...
    private void initViews() {
        mWv_hour = (WheelVerticalView) findViewById(R.id.dialog_sportcondition_wvv_hour);
        mWv_min = (WheelVerticalView) findViewById(R.id.dialog_sportcondition_wvv_min);
        whv_day = (WheelHorizontalView) findViewById(R.id.dialog_sportcondition_wv_day);
        tv_month = (TextView) findViewById(R.id.dialog_sportcondition_tv_month);
        tv_between = (TextView) findViewById(R.id.dialog_sportcondition_tv_between);
