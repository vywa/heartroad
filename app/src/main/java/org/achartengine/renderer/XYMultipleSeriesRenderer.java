...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
   ...
   // private String targetDescription = "";   //目标的文字描述
    ...
    //TODO 
    private ArrayList<String> targetDescription = new ArrayList<String>();
    private ArrayList<Float> targetValue = new ArrayList<Float>();
    public float getTargetValue(int index) {
        return targetValue.get(index);
    }

    public void addTargetValue(float targetValue) {
        this.targetValue.add(targetValue);
    }
    
    public String getTargetDescription(int index) {
        return targetDescription.get(index);
    }
    
    public void addTargetDescription(String targetDescription) {
    	this.targetDescription.add(targetDescription);
    }
    
    public int getTargetSize(){
    	return targetValue.size();
    }
   ...
   // private int targetLineColor = Color.BLUE;  //目标线的颜色
    private ArrayList<Integer> targetLineColores =new ArrayList<Integer>();
    public void addTargetLineColor(int targetLineColor) {
    	targetLineColores.add(targetLineColor);
    }
    
    public int getTargetLineColor(int index) {
    	return targetLineColores.get(index);
    }
