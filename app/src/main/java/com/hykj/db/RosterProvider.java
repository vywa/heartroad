...
public class RosterProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.hykj.provider.Roster";
	...
	private static class RosterDatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("CREATE TABLE " + TABLE_ROSTER + " (" + RosterConstants._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + RosterConstants.JID + " TEXT UNIQUE ON CONFLICT REPLACE, "
					+ RosterConstants.ALIAS + " TEXT, " + RosterConstants.STATUS_MODE + " INTEGER, " + RosterConstants.STATUS_MESSAGE + " TEXT, " + RosterConstants.GROUP + " TEXT, "
					+ RosterConstants.SUBSCRIBE + " TEXT,"+RosterConstants.USERID+" TEXT);");
